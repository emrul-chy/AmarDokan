		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="<?= base_url(); ?>">
						<span>A</span>mar
						<span>D</span>okan
						<img src="<?= base_url(); ?>images/logo2.png" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
			<div class="col-md-8 header">
				...
				<ul>
					...
					<?php if ($this->session->userdata('username') != "") : ?>
						<li>
							<a href="<?= base_url()?>account/purchase">
								<span class="fa fa-user" aria-hidden="true"></span> My Account </a>
						</li>
					<?php endif; ?>
					...
					<?php if ($this->session->userdata('role') == "Admin") : ?>
						<li>
							<a href="<?= base_url()?>admin/panel">
								<span class="fa fa-check" aria-hidden="true"></span> Admin Panel </a>
						</li>
					<?php endif; ?>

					<?php if ($this->session->userdata('role') == "Delivery Man") : ?>
						<li>
							<a href="<?= base_url()?>delivery/panel">
								<span class="fa fa-check" aria-hidden="true"></span> Delivery Panel </a>
						</li>
					<?php endif; ?>
				...
				<div class="agileits_search">
					<form action="<?= base_url() . "pages/search" ?>" method="post">
						<input name="search" id="products" type="search" placeholder="Search product..." required="">
				...
				<div class="top_nav_right">
					<div class="wthreecartaits wthreecartaits2 cart cart box_1">
						<form action="#" method="post" class="last">
							...
							<button style="width: 100px" class="w3view-cart" type="submit" name="submit" value="">
				...
				<form action="#" method="post">
					<select onchange="location = this.value" id="agileinfo-nav_search" name="agileinfo_search" required="">
						...
						foreach ($category as $row) {
							?>
							<option value="<?= base_url() . "category/view/" . $row->id ?>"><?= $row->name ?></option>
							<?php
						}
						?>
					</select>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<div class="col-sm-4 multi-gd-img">
												<img src="<?= base_url(); ?>images/nav.png" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
									</ul>
								...
								<li class="">
									<a class="nav-stylehead" href="<?= base_url(); ?>contact.html">Contact</a>
								</li>
							</ul>
						</div>
					</div>
