  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Create New</li>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body"> 
          <form method="post" enctype="multipart/form-data" action="<?= base_url() . "admin/createTag_process/"?>">
...
?>
              ...
              <div class="col-sm-10">
                <input style="padding-left: 15px;" name="top" type="checkbox"> <label>Yes</label>
              </div>
            </div>
					  <div class="form-group row">
					    <div class="col-sm-10">
